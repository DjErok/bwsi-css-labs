...
def request_sanitized_number(prompt: str) -> float:
    """
    Function to request and sanitize user input for a numeric value.
...
# Maps operation names to grammatically correct gerund forms for display
OPERATION_GERUNDS = {
    "add": "adding",
...
def main():
    ...
    try:
        ...
        gerund = OPERATION_GERUNDS.get(operation, operation + "ing")
        print(f"The result of {gerund} {num1} and {num2} is: {result}")
